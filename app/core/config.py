...
class Settings(BaseSettings):
    ...
    # Rate limiter / dedup sidecar (Rust/Axum) — shared across Celery worker
    # processes for outbound scraper politeness. Distinct from flask-limiter
    # above/elsewhere, which throttles *inbound* requests to this API.
    RATELIMITER_HOST: str = "localhost"
    RATELIMITER_PORT: int = 8090
    RATELIMITER_API_KEY: str = ""
    RATELIMITER_DEFAULT_MAX_RPS: int = 2
    RATELIMITER_DEDUP_TTL_SECS: int = 3600
