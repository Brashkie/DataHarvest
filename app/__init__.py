...
def create_app(config_name: Optional[str] = None) -> Flask:
    ...
    logger.info(
        ...
        f"port={app.config.get('APP_PORT', 5050)}"
    )
...
def _configure_logging(app: Flask) -> None:
    ...
    # Windows consoles default stdout/stderr to the legacy system codepage
    # (e.g. cp1252), which can't encode the emoji/box-drawing characters used
    # in log messages and startup banners — that raises UnicodeEncodeError
    # and crashes the process before it ever starts serving. Force UTF-8.
