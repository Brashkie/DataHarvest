...
import type { FormatEnum } from '../lib/types.generated'
...
export function ReportsPage() {
  ...
  const handleExport = async () => {
    ...
    await exportData.mutateAsync({ rows: [], format: selectedFormat as FormatEnum, filename })
  }
  ...
  return (
    <div className="h-full overflow-auto p-5 space-y-5 bg-[var(--bg)]">
      ...
      <Panel title="Export Data" subtitle="Choose a format and dataset to export">
        {/* Format picker */}
        <div data-tour="format-picker" className="grid grid-cols-2 sm:grid-cols-5 gap-3 mb-6">
        ...
        {/* Dataset picker */}
        <div data-tour="dataset-picker" className="mb-4">
        ...
        <div className="flex items-center gap-3">
          ...
          <button data-tour="export-btn" className="btn-primary"
