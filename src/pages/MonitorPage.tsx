...
import { Cpu, Server, HardDrive, Radio } from 'lucide-react'
import { AreaChart, Area, XAxis, YAxis, ResponsiveContainer, CartesianGrid, Tooltip } from 'recharts'
import { clsx } from 'clsx'
import { useSystemMetrics, useCeleryStats, useScraperJobs } from '../hooks/useApi'
import { Panel, StatCard, Badge, StatusBadge } from '../components/ui'
...
export function MonitorPage() {
  ...
  return (
    <div className="h-full overflow-auto p-5 space-y-5 bg-[var(--bg)]">
      {/* System Stats */}
      <div data-tour="monitor-stats" className="grid grid-cols-2 sm:grid-cols-4 gap-4">
      ...
      {/* Charts Row */}
      <div data-tour="monitor-charts" className="grid grid-cols-1 sm:grid-cols-2 gap-4">
