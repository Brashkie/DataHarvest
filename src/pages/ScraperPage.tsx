...
import type { CreateScraperJobRequest } from '#/lib/types.generated'
...
export function ScraperPage() {
  ...
  const handleCreate = async () => {
    ...
    await createJob.mutateAsync(form as unknown as CreateScraperJobRequest)
    setShowCreate(false)
  ...
  return (
    <div style={{ height: '100%', display: 'flex', flexDirection: 'column', overflow: 'hidden', background: 'var(--bg)' }}>
      ...
      {/* Stats */}
      <div className="grid grid-cols-2 sm:grid-cols-4" style={{ gap: 16, padding: '16px 20px 12px' }}>
      ...
      <div style={{ padding: '0 20px 12px' }}>
        <Panel title="URL Tester" subtitle="Quick check before creating a job" actions={<Badge variant="emerald">Live</Badge>}>
          ...
          {urlTest.result?.reachable && (
            <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6" style={{ gap: 8, marginTop: 12 }}>
              {([
                ['Reachable',   '✅ Yes'],
      ...
      <div
        ...
        style={{ flex: 1, gap: 16, padding: '0 20px 20px', overflow: 'hidden', minHeight: 0 }}
      >

        {/* Jobs table */}
        <div
          data-tour="jobs-table"
          className="panel w-full md:w-[52%] shrink-0 max-h-[45vh] md:max-h-none"
