...
import {
  BarChart3, Upload, Zap, TrendingUp, AlertTriangle, Download, Filter,
} from 'lucide-react'
import { clsx } from 'clsx'
import { analyticsApi } from '#/lib/api'
import { StatCard, Panel, Tabs, Badge, Empty, Spinner } from '#/components/ui'
  ...
  return (
    <div className="h-full flex flex-col overflow-hidden" style={{ background: 'var(--bg)' }}>
      ...
      <div className="flex items-center gap-3 px-4 py-3 shrink-0 flex-wrap">
        {/* Dataset selector */}
        <div data-tour="analytics-dataset" className="flex items-center gap-1.5 flex-wrap">
        ...
        <button data-tour="analytics-profile-btn" className="btn btn-secondary text-xs py-1.5 gap-1.5" onClick={handleProfile} disabled={profiling}>
      ...
      {/* Content */}
      <div data-tour="analytics-content" className="flex-1 overflow-auto p-4 space-y-4">
