...
export function useTransformDataset() {
  const qc = useQueryClient()
  return useMutation({
    mutationFn: ({ id, ops }: { id: string; ops: Record<string, unknown>[] }) =>
...
export function useDataProfile(rows: Record<string, unknown>[], enabled = true): UseQueryResult<DataProfile> {
  return useQuery({
...
export function usePatterns(rows: Record<string, unknown>[]) {
  return useQuery({
...
/** Correlation matrix */
export function useCorrelations(rows: Record<string, unknown>[]) {
  return useQuery({
...
export function useSqlQuery() {
  return useMutation({
    mutationFn: ({ query, rows }: { query: string; rows: Record<string, unknown>[] }) =>
...
export function useChart() {
  return useMutation({
    mutationFn: (payload: ChartRequest) => analyticsApi.chart(payload),
    onError: (e: Error) => toast.error(e.message),
  })
}
...
export function useCreatePipeline() {
  const qc = useQueryClient()
  return useMutation({
    mutationFn: async (payload: CreatePipelineRequest) =>
...
export function useUpdatePipeline() {
  const qc = useQueryClient()
  return useMutation({
    mutationFn: ({ id, payload }: { id: string; payload: Partial<CreatePipelineRequest> }) =>
...
export function useTrainModel() {
  const qc = useQueryClient()
  return useMutation({
    mutationFn: async (payload: TrainModelRequest) => {
...
export function usePredict() {
  return useMutation({
    mutationFn: (payload: PredictRequest) =>
