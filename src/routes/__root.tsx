...
function AppInner() {
  ...
  useLiveEvents({ onConnect, onDisconnect })
...
// `children` is required by TanStack Start's `shellComponent` signature, but this
// app renders its route tree via the explicit <Outlet /> in AppInner instead —
// verified via SSR output that page content still renders correctly either way.
